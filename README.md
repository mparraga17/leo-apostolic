...
All net revenue generated by Leo Look Up (AdMob + Amazon affiliates) is donated to **Fundación Social Hijas de la Caridad** (tax ID G88640958, Spanish national Registry of Foundations no. 2352), a Madrid-based charity helping families, homeless people, migrants and vulnerable groups. The pledge is surfaced in-app (About modal + Shop banner), in the public Terms of Use, and links to [fsocialhijasdelacaridad.org](https://fsocialhijasdelacaridad.org/).

Product rationale: a devotional audience responds to mission-aligned transparency. Tying monetization to a Vincentian charity (same spiritual tradition as the app's content) increases trust, click-through intent on the Shop, and word-of-mouth — while doing genuine good.
...
- Social commitment: 100% of proceeds pledged to Fundación Social Hijas de la Caridad
